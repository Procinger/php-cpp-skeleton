...
INI_DIR_CLI		= /etc/php5/cli/conf.d/
INI_DIR_APACHE	= /etc/php5/apache2/conf.d/
...
install:
						...
						${CP} ini/${INI} ${INI_DIR}
						${LN}	${INI_DIR}${INI} ${INI_DIR_CLI}${INI}
						${LN}	${INI_DIR}${INI} ${INI_DIR_APACHE}${INI}
...
uninstall:
						...
						${RM} ${INI_DIR}${INI}
						${UNLINK} ${INI_DIR_CLI}${INI}
						${UNLINK} ${INI_DIR_APACHE}${INI}
